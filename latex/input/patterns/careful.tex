...
\begin{frame}{Common criticism}
	\begin{quote}
		Design patterns are used \hhl{excessively} and introduce \hhl{unneeded complexity}.
	\end{quote}
	%
	\begin{itemize}
		%
		...
		\item 
		Extreme opposite: \defn{Inner platform effect} (a system so customizable, that it reproduces your development platform)
	\end{itemize}
\end{frame}

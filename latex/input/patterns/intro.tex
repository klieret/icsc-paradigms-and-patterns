...
\begin{frame}{Repetition: Object Oriented Programming}
	...
	\bigskip
	\dots
	Perhaps introduce class methods since we need them for the factory patterns
\end{frame}
...
\begin{frame}{Performance considerations}
	...
	\bigskip
	However, when writing performance critical (C++) code, you should avoid unnecessary \enquote{detours}:

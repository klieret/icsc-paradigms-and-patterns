\begin{frame}
	\tableofcontents[]
	Slides + material available at \hhl{\url{github.com/klieret/icsc-paradigms-and-patterns}}
\end{frame}
...
\begin{frame}{Performance considerations}
	...
	\begin{itemize}
		...
		\item Consider inlining simple functions \srem{(e.g. getters and setters)}
